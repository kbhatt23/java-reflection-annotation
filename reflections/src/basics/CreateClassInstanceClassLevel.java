...
public class CreateClassInstanceClassLevel {
	public static void main(String[] args) {
		try {
			...
			CreateClassInstanceClassLevel a = new CreateClassInstanceClassLevel();
	...
	private void checkClassNameFactory(Class<?> classOld) {
		...
		//try {
			...
			Class<?> classNew = PrivateConstructorClass.class;
